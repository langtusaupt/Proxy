...
install_3proxy() {
    ...
    wget https://raw.githubusercontent.com/langtusaupt/Proxy/master/scripts/3proxy.service-Centos8 --output-document=/3proxy/3proxy-0.9.4/scripts/3proxy.service2
